...
namespace Platform
{
    ...
    IC FileHandle CreateFile(const char* FilePath, bool SharedWrite)
    {
        ...
        auto FileSource = ::CreateFileW(Path, FlagsLeft, FlagsRight, 0, OPEN_EXISTING, 0, 0);
    ...
    IC FileHandle OpenFile(const char* FilePath)
    {
        ...
        auto Handle = ::CreateFileW(Path, GENERIC_READ, FILE_SHARE_READ, 0, OPEN_EXISTING, 0, 0);
